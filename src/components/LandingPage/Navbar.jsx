...
const Navbar = () => {
  ...
  return (
    <nav
      className={`bg-white py-3 md:py-4 lg:py-6 sticky top-0 z-50 ${
        scrolled ? "shadow-md" : ""
      }`}
    >
      <div className="container mx-auto px-4 lg:px-6 flex justify-between items-center">
        ...
        <div className="flex lg:hidden items-center">
          <button
            ...
            className="ml-2 p-2 text-gray-700 hover:text-blue-600"
          >
          ...
          >
            <div className="container mx-auto px-4 py-2">
              ...
              <div className="space-y-1">
                ...
                <Link
                  to="/news"
                  className="block px-2 py-3 font-semibold hover:text-blue-600"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Tin tức
                </Link>
